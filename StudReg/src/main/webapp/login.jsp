...
body{
  background-image:url("https://schoolscompared.com/wp-content/uploads/2020/01/Indian-School-Results-Dubai-Celebration-1024x617.jpg");
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
	...
	<div class="container">
		<div  class="row d-flex justify-content-center ">
			<div id="crd"  class="card crdadj  bg-info">
				
				<form  action="school/login" >
					<div align="center">
						<h3><u><i>STUDENT LOGIN</i></u></h3>
						<p>Uname OR roll no<input type="text" style="border-radius:20px;width:28vh;" placeholder="Student full Name or id" width="20px" name="unrl"></p> 
						<p>password:  <input type="text" style="border-radius:20px;width:23vh;" placeholder=" dob (no '/')+first name " name="pwd"></p> 
						<button id="btn" style="opacity:0.99;" type="submit" class=" bg-danger mt-2"> login</button>
					</div>
				</form>
				<p align:"right">Don't have an account? <a style="color:red;" href="/StudReg/register.jsp">Register</a></p>
			</div>
		</div>
	</div>
