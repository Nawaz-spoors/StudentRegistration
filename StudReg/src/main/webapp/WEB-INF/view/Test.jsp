...
<h1 id="qst" align="center" style="color:green"><%= session.getAttribute("qst") %></h1>
<form align="center" id="input" action="validate"><input type="text" name="ansr"><button style="display:none" id="btn">check</button></form>


<h1 id="answer" align="center"><b>SCORE is    </b><%=session.getAttribute("result") %></h1>
<form align="center" action="test" ><button  id="next">Nxt Qst</button></form>
<form align="center" action="/StudReg/login.jsp"><button>Submit Test</button></form>
